 ...
 * <p>
 * See also {@link BinaryDump} and {@link PictureDump}. For more full-featured
 * versions, see the Unix utilities {@code od} (octal dump) and {@code hexdump}
 * (hexadecimal dump).
 * <p>
 *
...
public class HexDump {
	 ...
	 * output using hexademical notation, k hex digits per line, where k is given as
	 * a command-line integer (defaults to 16 if no integer is specified); also
	...
	public static void main(String[] args) {
		try {
			System.setIn(new FileInputStream("output.bin"));
