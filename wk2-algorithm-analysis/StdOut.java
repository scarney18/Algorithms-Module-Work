 ...
 * output.
 * <p>
 * <b>Getting started.</b> To use this class, you must have {@code StdOut.class}
 ...
 * </pre>
 * <p>
 * <b>Differences with System.out.</b> The behavior of {@code StdOut} is similar
 * to that of {@link System#out}, but there are a few technical differences:
 * <ul>
 * <li>{@code StdOut} coerces the character-set encoding to UTF-8, which is a
 * standard character encoding for Unicode.
 * <li>{@code StdOut} coerces the locale to {@link Locale#US}, for consistency
 * with {@link StdIn}, {@link Double#parseDouble(String)}, and floating-point
 * literals.
