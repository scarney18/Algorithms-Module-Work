...
/**
 * The {@code BinaryDump} class provides a client for displaying the contents of
 * a binary file in binary.
 * <p>
 * For more full-featured versions, see the Unix utilities {@code od} (octal
 * dump) and {@code hexdump} (hexadecimal dump).
 * <p>
...
public class BinaryDump {
	...
	/**
	 * Reads in a sequence of bytes from standard input and writes them to standard
	 * output in binary, k bits per line, where k is given as a command-line integer
	...
	public static void main(String[] args) {
		try {
			System.setIn(new FileInputStream("genomeVirusCompressed.bin"));
