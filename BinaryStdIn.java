 ...
 * from standard input, either one bit at a time (as a {@code boolean}), 8 bits
 ...
 * <p>
 * The client should not intermix calls to {@code BinaryStdIn} with calls to
 * {@code StdIn} or {@code System.in}; otherwise unexpected behavior will
 * result.
 *
...
public final class BinaryStdIn {
	 ...
	 * @throws NoSuchElementException if there are fewer than 8 bits available on
	 *                                standard input
	 */
	 ...
	 * @throws NoSuchElementException if standard input is empty or if the number of
	 *                                bits available on standard input is not a
	 *                                multiple of 8 (byte-aligned)
	 */
	 ...
	 * @throws NoSuchElementException if there are fewer than 16 bits available on
	 *                                standard input
	 */
	 ...
	 * @throws NoSuchElementException if there are fewer than 32 bits available on
	 *                                standard input
	 */
	 ...
	 * @throws NoSuchElementException if there are fewer than 64 bits available on
	 *                                standard input
	 */
	...
	/**
	 * Test client. Reads in a binary input file from standard input and writes it
	 * to standard output.
	 *
